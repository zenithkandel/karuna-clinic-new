...
<section class="page-banner"
    style="background-image:url('https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?auto=format&fit=crop&w=1700&q=80');">
    <div>
        <h1>Connect With Our Clinic Team</h1>
        <p>Book appointments, ask questions, and get support from our care desk quickly.</p>
    </div>
</section>
...
<section class="section">
    <div class="container form-layout">
        <article class="panel reveal" id="appointment-form">
