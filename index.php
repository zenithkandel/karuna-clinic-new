...
<section class="hero"
    style="background-image:url('https://images.unsplash.com/photo-1666214280391-8ff5bd3c0bf0?auto=format&fit=crop&w=1800&q=80');">
    <div class="container">
                    ...
                    <article class="notice-card reveal">
                        ...
                        <?php if (!empty($notice['target_url'])): ?>
                            <a href="<?php echo htmlspecialchars($notice['target_url']); ?>" target="_blank" rel="noopener">Open
                                Notice <i class="fas fa-arrow-right"></i></a>
                        <?php endif; ?>
                    </article>
                <?php endforeach; ?>
            </div>
...
<section class="section" style="padding-top: 0;">
    <div class="container split-story">
        <div class="story-image reveal"
            style="background-image:url('https://images.unsplash.com/photo-1576091160550-2173dba999ef?auto=format&fit=crop&w=1200&q=80');">
        </div>
        <article class="story-panel reveal">
            <h2><i class="fas fa-heart-pulse"></i> A Welcoming Clinical Experience</h2>
            <p>Our approach combines medical rigor with communication that patients and families can understand, so
                treatment decisions feel confident and informed.</p>
