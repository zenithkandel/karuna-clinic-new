...
<section class="hero" style="background-image:url('assets/images/hero-main.webp');">
    <div class="container">
        <div class="hero-box">
            ...
            <p>Evidence-based healthcare with experienced doctors for diabetes, orthopedic conditions, and general medical concerns in Pokhara.</p>
            <div class="btn-row">
    ...
    <div class="container">
        ...
        <div class="notice-list">
            ...
            <article class="notice-card">
                ...
                <a href="<?php echo htmlspecialchars($notice['target_url']); ?>" target="_blank" rel="noopener">Open Notice Link <i class="fas fa-arrow-right"></i></a>
                <?php endif; ?>
            </article>
            <?php endforeach; ?>
        </div>
...
<section class="section">
    <div class="container media-split">
        ...
        <div class="text-pane">
            ...
            <p>We provide comprehensive care for diabetes management, orthopedic problems, and day-to-day medical needs under one clinic roof.</p>
            <ul>
