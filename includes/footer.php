...
<footer class="site-footer">
    <div class="container footer-grid">
        <section>
            ...
            <p>Patient-first healthcare with dedicated diabetes care, orthopedic guidance, and general medical
                consultation in Pokhara.</p>
        </section>
        <section>
        ...
        <section>
            ...
            <div class="social-row">
                <a href="<?php echo htmlspecialchars($facebook); ?>" target="_blank" rel="noopener"><i
                        class="fab fa-facebook-f"></i></a>
                <a href="<?php echo htmlspecialchars($instagram); ?>" target="_blank" rel="noopener"><i
                        class="fab fa-instagram"></i></a>
                <a href="<?php echo htmlspecialchars($linkedin); ?>" target="_blank" rel="noopener"><i
                        class="fab fa-linkedin-in"></i></a>
                <a href="<?php echo SITE_URL; ?>admin/login.php" title="Admin Portal"><i
